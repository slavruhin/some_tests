...
public class Gebaeude {
	...
	class Stockwerk {
		...
		Stockwerk(int StockwerkNummer, int AnzahlRaeumen) {
			...
			for(int i = 0 ; i < AnzahlRaeumen; ++i)
				raume.add(new Raum(StockwerkNummer, i));
		}
	...
	class Raum {
		int StockwerkNummer, RaumNummer;
		
		Raum(int StockwerkNummer, int RaumNummer) {
			this.StockwerkNummer = StockwerkNummer;
	...
	Gebaeude(String Strassennamen, String Hausnummer, int AnzahlStockwerke, int AnzahlRaeumen) {	
