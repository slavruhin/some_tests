...
class Test006 {
	...
	// abstract class Circle implements Shape { private int radius; public void draw();}
	// class Circle extends Shape { private int radius; public void draw() {/* code here */}}
	// abstract class Circle implements Shape { private int radius; public void draw() { /* code here */ } }
...
// What is the result?
class Test018 {
	static abstract class Vehicle { public int speed() { return 0; } }
	static class Car extends Vehicle { public int speed() { return 60; } }
	static class RaceCar extends Car { public int speed() { return 150; } }
...
// What is the result?
class Test022 {
	static class Food implements Serializable {int good = 3;}
	
	static class Fruit extends Food {int juice = 5;}
	
	static class Banana extends Fruit {
		int yellow = 4;
		//more Banana methods go here
		public Banana serializeBanana(Banana b) { return b; }
		public Banana deserializeBanana() { return this; }
	}
...
class Test023 {
	public static void test() {
		...
		//d = df.parse(ds);
		//d = df.getDate(ds);
		try { d = df.parse(ds);   } catch(ParseException e) { };
